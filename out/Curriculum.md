...
Сигмоида затухает и теоретически и практически. Затухание градиента. Инициализация весов. Инициализация Ксавье (Xavier Glorot). Инициализация Каймин Хе (Kaiming He). Важность инициализации весов. Обобщение инициализаций Ксавье и Каймин Хе. Ортогональная инициализация. Инициализация весов в Pytorch. Нормализация. Нормализация входных данных. Covariate shift (Ковариантный сдвиг). Internal covariate shift. BatchNormalization. Другие Normalization. Регуляризация. L1, L2 регуляризации. Dropout. DropConnect. DropBlock. BatchNormalization до или после Dropout. Оптимизация весов нейросетей. Обзор популярных оптимизаторов. Сравнение оптимизаторов. Режимы обучения. Ранняя остановка. Понижение шага обучения на каждой эпохе. Cyclical learning schedule. Neural Network WarmUp

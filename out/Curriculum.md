...
Введение в сверточные нейронные сети. Полносвязная нейронная сеть. Нарушение связей между соседними пикселями. Примеры 'hancrafted' фильтров. Свертка с фильтром. Сверточный слой нейросети. Основные параметры свёртки. Использование свёрточных слоёв. Пример сверточной сети. Визуализация. Визуализация весов. Визуализация фильтров промежуточных слоев.  Визуализация карт активаций. Feature extractor.

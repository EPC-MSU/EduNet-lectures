...
Проблемы при работе с реальной задачей машинного обучения. Общие подходы при работе с реальными данными. Нехватка данных. Дисбаланс классов. Аугментация. Transfer learning. Порядок действий при transfer learning. Практический пример transfer learning. Metric learning. Формирование векторов-признаков (embedding). Сиамская сеть (Siamese Network). Реализация сиамской сети
